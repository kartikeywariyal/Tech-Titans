...
const Cart = ({ cart, setCart }) => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen min-h-screen bg-gradient-to-b from-amber-50 to-orange-50 py-16 px-4 sm:px-6">
      <div className="max-w-5xl p-10 bg-gray-900 text-white rounded-lg shadow-lg w-full">
