    ...
    <nav className="p-4 bg-gray-900 text-white sticky top-0 z-50 shadow-lg">
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-6">
          ...
          <Link to="/special-offers" className="hover:text-yellow-400 transition-colors duration-300">Specials</Link>
          <Link to="/locations" className="hover:text-yellow-400 transition-colors duration-300">Locations</Link>
      ...
      {isMenuOpen && (
        <div className="md:hidden absolute top-16 left-0 right-0 bg-gray-800 p-4 flex flex-col shadow-lg">
          ...
          <Link to="/special-offers" className="py-2 hover:text-yellow-400" onClick={() => setIsMenuOpen(false)}>Specials</Link>
          <Link to="/locations" className="py-2 hover:text-yellow-400" onClick={() => setIsMenuOpen(false)}>Locations</Link>
